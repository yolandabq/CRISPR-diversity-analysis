...
Example of the analysis of one guide to see if the different replicates share the same most common alleles and 
to examine the effect of the standardization. 
...
#%% We normalized with respect to the % cleavage. 
