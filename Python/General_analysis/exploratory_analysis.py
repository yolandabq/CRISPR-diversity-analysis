...
Exploratory analysis. In this script, various analyzes are performed to explore general characteristics of the data:
    * Distribution of the frequency of the most common allele. 
    * Cutting efficiency. 
    * Distribution of the frequency of deletions. 
    * Distribution of the number of alleles obtained after using each guide. 
    * % GC of the guides. 
    * Accumulative sum of the alleles. 
...
#%% Distribution of the frequency when 1:1I is the most common allele. 
...
#%% Plot of the cutting efficiency
...
#%% Plot of the frequency of distributions. 
...
#%% Number of alleles obtained after using each guide (normalized frequency > 1/1000)
...
#%% We also explored the CG percentage of the guides to see if it was related to the cutting efficiency
...
#%% Correlation between the nº of alleles and the cutting efficiency
...
#%% Cumulative frequency of the alleles
