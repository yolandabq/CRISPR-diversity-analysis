...
Script to analyze the diversity of the mutational profiles using Shannon Entropy parameter. 
...
#%% Computing the entropy of the mutational profiles resulting from each guide. 
...
#%% Correlation between entropy and cutting efficiency
...
pearson_coef, p_value = scipy.stats.pearsonr(x, y)
...
#%% Correlation between entropy and the frequency of the most common repairing outcome
...
#%% we separate the guides into groups depending on their entropy value
